# TGA Offer Page - The Great Awaken Marketing Firm

This project is a high-ticket contractor lead generation page for **The Great Awaken Marketing Firm (TGA)**, built with a vanilla HTML/CSS/JS stack.
...
## Maintenance
- Ensure all modifications adhere to the gold-and-navy aesthetic.
- Maintain a focus on high-ticket contractors ($250K+ revenue target).
- All changes MUST be pushed to the `master` branch.
- This is a global TGA project; do not use individual client names for global branding elements.
