document.addEventListener('DOMContentLoaded', () => {
    ...
    const steps = {
        1: {
            title: "What is your primary contracting niche?",
            options: [
                { label: "Concrete/Hardscape", value: "concrete-hardscape" },
                { label: "Landscaping", value: "landscaping" },
                { label: "Excavation/Clearing", value: "excavation-clearing" },
                { label: "Other High-Ticket", value: "other" }
            ]
        },
        2: {
        ...
        4: {
            title: "Where should we send your custom growth plan?",
            type: "form"
        }
    };
        ...
        if (step.type === "form") {
            html += `
                <form id="lead-form">
                    ...
                    <button type="submit" class="submit-btn">Get My Growth Plan</button>
                </form>
            `;
        } else {
    ...
    function handleFinalSubmit(e) {
        ...
        quizRoot.innerHTML = `
            <div class="quiz-step active">
                <h2>Thank You!</h2>
                <p>We've received your information. A specialist from The Great Awaken Marketing Agency will reach out to you within 24 hours to review your growth plan.</p>
            </div>
        `;
    }
